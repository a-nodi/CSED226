...
# 3. [DONE] test data f1 score wandb log
# 4. [DEPRET] tree diagram wandb log
# 5. [DEPRET] train, val accuracy wandb log
# 6. [DEPRET] train, val, test f1 score wandb log
# 7. [DONE] submission data csv print
# 8. [DONE] feature importance wandb log (hist)
...
def main():
    ...
    submission_feature = scaler.fit_transform(submission_feature)
    ...
    print(classification_report(submission_prediction, submission_prediction))
