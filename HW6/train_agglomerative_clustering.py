...
def sweep():
    ...
    parser.add_argument('--sweep_count', dest='sweep_count', type=int, default=100)
    ...
    sweep_id = wandb.sweep(sweep_config, project="IDA-HW6-cluster-agglomerative-clustering") 
