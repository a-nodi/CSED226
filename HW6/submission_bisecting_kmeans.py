...
def main():
    ...
    put_submission_data(prediction, "submission_bisecting_kmeans.csv")
    print("Done!")
...
def sweep():
    ...
    sweep_id = wandb.sweep(sweep_config, project="IDA-HW6-cluster-bisecting-kmeans") 
