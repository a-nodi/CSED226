...
def main():
    ...
    clusterable_embedding = umap.UMAP(
        n_neighbors=822,
        min_dist=0.0520515112119696,
        n_components=24,
    ).fit_transform(data)
    
    clusterer = Birch(
        threshold=0.18063394949515424,
        branching_factor=10,
        n_clusters=20,
    )
    ...
    """
    put_submission_data(prediction, "submission_birch.csv")
    print("Done!")
...
def sweep():
    ...
    sweep_id = wandb.sweep(sweep_config, project="IDA-HW6-cluster-birch") 
