...
def main():
    ...
    clusterable_embedding = umap.UMAP(
        n_neighbors=969,
        min_dist=0.4869579184372238,
        n_components=20,
    ).fit_transform(data)
    
    clusterer = AffinityPropagation(
        damping=0.7571447531990068,
        affinity="euclidean"
    )
    ...
    """
    put_submission_data(prediction, "submission_affiniti_propagation.csv")
...
def sweep():
    ...
    sweep_id = wandb.sweep(sweep_config, project="IDA-HW6-cluster-affinity-propagation") 
